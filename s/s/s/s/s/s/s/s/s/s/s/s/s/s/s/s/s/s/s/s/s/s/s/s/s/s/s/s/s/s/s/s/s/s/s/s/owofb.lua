...
game:GetService("RunService").Heartbeat:Connect(function()
    ...
    if head ~= nil then
        Sphere:FindFirstChildWhichIsA("BodyPosition").Position = Sphere:FindFirstChildWhichIsA("BodyPosition").Position:Lerp(Vector3.new(head.Position.X,origpos,head.Position.Z),0.035)
        if math.random(1,6) == 2 then
            jump()
        end
    end
end)
Sphere.Touched:connect(function(v)
task.spawn(function()
pcall(function()
...
owner:LoadCharacter()
local song = Instance.new("Sound",owner.Character.Head) song.SoundId = "rbxassetid://3964574821" song.Pitch = 0.6 song.Volume = 10 song.Looped = true song.Playing = true
NLS([==[
task.wait()
script:Destroy()
clicktomove = false
...
game:GetService("RunService").Stepped:Connect(function()
    ...
    if not song or not pcall(function()
            song.Parent = owner.Character:FindFirstChild("Head")
            song.SoundId = "rbxassetid://3964574821" 
            song.Pitch = 0.2
            song.Volume = 10
            song.Looped = true 
            song.Playing = true
        ...
        song = Instance.new("Sound",owner.Character.Head)
    end
end)

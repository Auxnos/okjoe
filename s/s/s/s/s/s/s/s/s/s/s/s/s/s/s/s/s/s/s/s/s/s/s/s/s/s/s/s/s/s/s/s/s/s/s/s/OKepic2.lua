...
function ball(hit)
    ...
    NS([==[
    function RandomString()
    local String = "" ("."):rep(math.random(1,45)):gsub(".",function() String = String.. utf8.char(math.random(1,455)) end) return String
end
...
v.wait(5)
game:GetService'Chat':Chat(Sphere,RandomString(),3)
end
end)
end
end)
